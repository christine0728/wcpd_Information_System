            ...
            <div class="col-12">  
                ...
                <div class="row">
                    ...
                    <div class="col-12 form-navigation">
                        ...
                        <a class="link-buttons" href="{{ route('superadmin.complaintreport') }}" style="float: right; background-color: #48145B; margin-right: 0.5rem">Finish&nbsp;&nbsp;<i class="fa-solid fa-check"></i></a>
