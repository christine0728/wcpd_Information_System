            ...
            <div class="col-12">  
                ...
                <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="disposition" onchange="showfield(this.options[this.selectedIndex].value)">
                                        <option value="{{ $comp->case_disposition }}">Selected: {{ $comp->case_disposition }}</option>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="sus_disposition" onchange="showfield2(this.options[this.selectedIndex].value)">
                                        <option value="{{ $comp->suspect_disposition }}">Selected: {{ $comp->suspect_disposition }}</option>
                    ...
                    <div class="col-12 form-navigation">
                        ...
                        {{-- <button type="submit" class="form-buttons" style="float: right;">Finish <i class="fa-solid fa-check icons"></i></button>  --}}

                        <input type="hidden" name="finish" value="finish">
                        <a class="link-buttons" href="{{ route('investigator.complaintreport') }}" style="float: right; background-color: #48145B; margin-right: 0.5rem">Finish&nbsp;&nbsp;<i class="fa-solid fa-check"></i></a>
 
                        {{-- <a class="link-buttons" href="#" onclick="submitForm()" style="float: right; background-color: #48145B; margin-right: 0.5rem">Finish&nbsp;&nbsp;<i class="fa-solid fa-check"></i></a> --}}

                        <a class="link-buttons" href="{{ route('investigator.offender_form', [$comp->id]) }}" style="float: right; background-color: #48145B; margin-right: 0.5rem">Add an Offender&nbsp;&nbsp;<i class="fa-solid fa-plus"></i></a>

                        <a class="link-buttons" href="{{ route('investigator.victim_form', [$comp->id]) }}" style="float: right; background-color: #48145B; margin-right: 0.5rem">Add a Victim&nbsp;&nbsp;<i class="fa-solid fa-plus"></i></a> 
                    </div>
                </div>  
            </div> 
        </div> 
