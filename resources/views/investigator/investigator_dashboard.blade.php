                    ...
                    <div class="col-12">
                        <div class="filter">
                            ...
                            <div class="date-filter">
                                ...
                                <input type="month" name="start_date" class="form-control" id="start_date" value="{{ old('end_date', isset($end_month) ? date('Y-m', strtotime($end_month)) : '') }}" max="{{ date('Y-m-d') }}" required>&nbsp;&nbsp;
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button id="download-button" class="form-buttons" style="width: 28%; margin-top: 1rem">Download Monthly Data&nbsp;&nbsp;<i class="fa-solid fa-download"></i></button>
                            </div>
                        </div>
                    </div> 
