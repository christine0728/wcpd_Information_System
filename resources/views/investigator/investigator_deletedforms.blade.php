        ...
        @section('content')
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="col-12">
                        <div class="filter">
                            <form action="filter-trash" method="GET">
                            <div class="date-filter">
                                ...
                                <a href="{{ route('investigator.trash') }}"><button type="button" class="link-buttons" style="background-color: #48145B"><i class="fa-solid fa-arrows-rotate"></i></button></a>
                            </div>
                            </form>
                        </div>
                    </div>
